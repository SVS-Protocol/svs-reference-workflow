...
Do not report wallet keys, API keys, request-signing secrets, access tokens, or
private evidence in a public issue.

Report security concerns privately to `security@svsprotocol.com`. Include only
